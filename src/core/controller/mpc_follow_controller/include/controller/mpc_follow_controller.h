 ...
 * ********************************************************
 */
#ifndef RMP_CONTROLLER_MPC_FOLLOW_CONTROLLER_H_
#define RMP_CONTROLLER_MPC_FOLLOW_CONTROLLER_H_
 ...
 */
class MPCFollowController : public nav_core::BaseLocalPlanner, Controller
{
public:
  /**
   ...
   * @brief Construct a new MPC planner object
   */
  MPCFollowController(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* costmap_ros);
