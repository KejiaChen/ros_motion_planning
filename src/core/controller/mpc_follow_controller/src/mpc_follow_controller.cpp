...
#include "controller/mpc_follow_controller.h"

PLUGINLIB_EXPORT_CLASS(rmp::controller::MPCFollowController, nav_core::BaseLocalPlanner)
 ...
 */
MPCFollowController::MPCFollowController() : initialized_(false), goal_reached_(false), tf_(nullptr)  //, costmap_ros_(nullptr)
{
}
 ...
 * @brief Construct a new MPC Controller object
 */
MPCFollowController::MPCFollowController(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* costmap_ros)
  : MPCFollowController()
{
 ...
 */
MPCFollowController::~MPCFollowController()
{
}
 ...
 */
void MPCFollowController::initialize(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* costmap_ros)
{
  if (!initialized_)
  {
    initialized_ = true;
 ...
 */
bool MPCFollowController::setPlan(const std::vector<geometry_msgs::PoseStamped>& orig_global_plan)
{
  if (!initialized_)
  {
 ...
 */
bool MPCFollowController::isGoalReached()
{
  if (!initialized_)
  {
 ...
 */
bool MPCFollowController::computeVelocityCommands(geometry_msgs::Twist& cmd_vel)
{
  if (!initialized_)
  {
    ROS_ERROR("MPC Controller has not been initialized");
